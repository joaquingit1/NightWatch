...
async def lifespan(app: FastAPI):
    ...
    if settings.scorer_backend == "live":
        ...
        # Display-only fatigue analysis is always on: overlays and /api/score
        # stay live in every robot operating mode (AGENTS.md invariant 13
        # permits display-only outside Sleep Analysis). Operating-mode gating
